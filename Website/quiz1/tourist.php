<?php
    ...
    // set the page name
    $pgname = isset($_GET['pg']) ? trim(strip_tags($_GET['pg'])) : 'tourist';
        ...
        <section id = "posts">
            <nav id = "menu">
                <ul> 
                    ...
                    <li><a class="active" href="tourist.php?pg=tourist" title = "Wisata">Tourist Spots</a></li>
                </ul>
            </nav>
            <article id="article"><?php echo file_get_contents('tourist.html'); ?></article>
        </section>
