<?php
    ...
    // set the page name
    $pgname = isset($_GET['pg']) ? trim(strip_tags($_GET['pg'])) : 'profile';
        ...
        <section id = "posts">
            <nav id = "menu">
                <ul> 
                    ...
                    <li><a class="active" href="profile.php?pg=profile" title = "Profile">Profile</a></li>
            ...
            <article id="article"><?php echo file_get_contents('profile.html'); ?></article>
        </section>
